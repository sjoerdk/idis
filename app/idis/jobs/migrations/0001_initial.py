# Generated by Django 2.1.5 on 2019-01-25 14:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('path', models.CharField(blank=True, default='', help_text='The path to this folder, without hostname and sharename', max_length=1024)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('input_files', models.ForeignKey(help_text='The files that are processed in this job', null=True, on_delete=django.db.models.deletion.SET_NULL, to='jobs.FileBatch')),
            ],
        ),
        migrations.CreateModel(
            name='NetworkShare',
        ...
        migrations.AddField(
            model_name='wadofile',
            name='source',
            field=models.ForeignKey(help_text='Where this data is coming from', null=True, on_delete=django.db.models.deletion.SET_NULL, to='jobs.WadoServer'),
        ),
        migrations.AddField(
            model_name='job',
            name='profile',
        ...
        migrations.AddField(
            model_name='folder',
            name='destination',
            field=models.ForeignKey(help_text='The share that this folder is on', null=True, on_delete=django.db.models.deletion.SET_NULL, to='jobs.NetworkShare'),
        ),
        migrations.AddField(
